...
different things from a page about DNS, so each lesson is written for one reader.
...
Not every topic has every rung, and that's deliberate. Monitoring has a beginner lesson
